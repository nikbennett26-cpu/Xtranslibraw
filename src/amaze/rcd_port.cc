...
// Copyright (c) Luis Sanz Rodriguez; tiled/optimised by Ingo Weyrich and
// Hanno Schwalm / RawTherapee (GPL-3).
//
// Vendored copy of RawImageSource::rcd_demosaic, extracted from RawTherapee
// 5.11 rtengine/rcd_demosaic.cc (lines 53-346). Includes swapped to the
// standalone shims and the StopWatch timing block removed; numeric body
// unchanged.
#include <cmath>
#include <cstdlib>
#include <iostream>
...
// ---------------------------------------------------------------------------
// Standalone free-function wrapper (see rcd_standalone.h).
// ---------------------------------------------------------------------------
                  ...
                  int (*fcfn)(int, int, void*), void* fcctx)
{
    ...
    src.rcd_demosaic(/*chunkSize*/ 1, /*measure*/ false);
}
